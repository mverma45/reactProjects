...
import { set } from 'msw/lib/types/context/set';
export declare const defaultContext: {
    status: (statusCode: number, statusText?: string | undefined) => import("msw/lib/types/response").ResponseTransformer<any>;
    set: typeof set;
    delay: (durationOrMode?: number | import("msw/lib/types/context/delay").DelayMode | undefined) => import("msw/lib/types/response").ResponseTransformer<any>;
